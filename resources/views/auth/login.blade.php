...
<body class="bg-gray-50 min-h-screen flex">
    ...
    <div class="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-600 to-indigo-800 text-white flex-col justify-center items-center relative overflow-hidden">
        ...
        <div class="relative z-10 text-center px-12">
            <h1 class="text-4xl font-bold mb-6">Sistem Informasi Absensi</h1>
            <p class="text-xl text-blue-100 mb-8">SDN Ciranjanggirang 2</p>
            <div class="bg-white/20 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-xl inline-block">
                <p class="text-sm font-medium">"Mencetak Generasi Cerdas dan Berkarakter"</p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div class="w-full max-w-md">
            <div class="text-center mb-10 lg:hidden">
                ...
                <p class="text-gray-500">SDN Ciranjanggirang 2</p>
            </div>
